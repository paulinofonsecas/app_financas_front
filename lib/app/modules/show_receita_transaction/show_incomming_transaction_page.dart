...
import 'controller/show_incoming_transaction_controller.dart';

class ShowIncomingTransactionPage extends StatelessWidget {
  const ShowIncomingTransactionPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    var controller = Get.put(ShowIncomingTransactionController(),
        tag: 'ShowReceitaTransactionController');
    ...
    return Row(
      ...
      children: [
        CircleInfo(
          ...
          backgroundColor: kVerdeAccentColor,
          title: 'Recebido',
        ),
        CircleInfo(
          icon: Icon(
